...
$query = "INSERT INTO user_login(user_email,user_password,user_role)  ";
$query .= "VALUES('$user_email','$user_password','w_$user_role')";
$login_query = mysqli_query($connection, $query);
$w_user_id = mysqli_insert_id($connection);
if($login_query) {
    $query = "INSERT INTO pharmtrix_w_user( `wholesale_subscription_code`,`user_id`, `first_name`, `wholesale_user_title`, `wholesale_user_role`, `wholesale_username`, `wholesale_user_password`, `wholesale_user_email`, `wholesale_user_phone`, `wholesale_user_access`, `wholesale_dated`, `wholesale_user_registrar`, `wholesale_user_status`,`created_by`)  ";
    $query .= "VALUES($user_code,$w_user_id, '$user_fullname','$user_title','$user_role','$user_username','$user_password','$user_email','$user_phone','$user_access','$user_regDate','$user_registrar',1,$user_id)";
