...
$user_id = useMiddleware();
    ...
    $query = "INSERT INTO pharmtrixw_supplier(`subscription_code`, `supplier_email`, `supplier_name`, `supplier_city`, `supplier_phone`, `supplier_address`, `supplier_registered_date`, `supplier_user`, `supplier_location`, `supplier_status`,`user_id`)  ";
